...
const CartProduct = ({item}: cartproductProps) => {
    ...
    return (
        <div className="bg-gray-100 rounded-lg flex items-center gap-4">
            <Image className="object-cover" src={item.image} alt='productImage' width={150} height={150} />
            <div className="flex items-center px-2 gap-4">
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center mt-1 justify-between border border-gray-300 px-4 py-1 rounded-full w-28 shadow-lg shadow-gray-300">
                            ...
                            className="w-6 h-6 flex items-center justify-center rounded-full text-base bg-transparent hover:bg-gray-300 duration-300">
                                <LuPlus />
                            </span>
                            <span>
                                {item.quantity}
                ...
                <div className="text-lg font-semibold text-bold text-amazon_blue">
